...
- Structured review field supporting_contracts references src/store.js, but that file was not included in context.
- qwen attempt 1 failed with TIMEOUT: The provider operation timed out.
- A council member failed, timed out, or was cancelled and was omitted from consolidation: Generation timed out after 180000ms
